package com.ccb.job.admin.core.route;
...
public abstract class ExecutorRouter {
    ...
    public abstract String route(String jobId, ArrayList<String> addressList);

    public static  String route(String jobId, ArrayList<String> addressList, String executorRouteStrategy){
