...
public class MailUtil {
	...
	static {
		host = PropertiesUtil.getString("ccb.job.mail.host");
		port = PropertiesUtil.getString("ccb.job.mail.port");
		username = PropertiesUtil.getString("ccb.job.mail.username");
		password = PropertiesUtil.getString("ccb.job.mail.password");
		sendFrom = PropertiesUtil.getString("ccb.job.mail.sendFrom");
		sendNick = PropertiesUtil.getString("ccb.job.mail.sendNick");
	}
