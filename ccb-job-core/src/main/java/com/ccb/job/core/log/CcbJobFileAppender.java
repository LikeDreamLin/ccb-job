 ...
 */
public class CcbJobFileAppender {
	private static  Logger logger = LoggerFactory.getLogger(CcbJobFileAppender.class);
	...
	public static  String makeLogFileName(Date triggerDate, String logId) {
        ...
        // filePath/
        File filePathDir = new File(CcbJobExecutor.logPath);
		...
		String logFileName = CcbJobFileAppender.sdf.format(triggerDate).concat("/").concat(String.valueOf(logId)).concat(".log");
		return logFileName;
	}
	...
	public static  void appendLog(String logFileName, String appendLog) {
		...
		File logFile = new File(CcbJobExecutor.logPath, logFileName);
